...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Mbol\Desktop\activities\opencv\envname'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Mbol\Desktop\activities\opencv\envname\Scripts\deactivate.nu'
